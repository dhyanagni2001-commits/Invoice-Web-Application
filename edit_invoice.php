...
?>
<title>Invoice Web Application</title>
        ...
        <div class="card-bodys">
            <form action="" id="invoice-form" method="post" class="invoice-form" role="form" novalidate="">
                <div class="load-animate animated fadeInUp">
                    <div class="row">
                        <div class="col-xs-12">
                            <h1 class="title">Invoice Web Application</h1>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                            ...
                            <div class="form-group">
                                <textarea class="form-control" rows="3" name="address" id="address" placeholder="Company Address"><?php echo $invoiceValues['order_receiver_address']; ?></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row mt-3 mb-3">
                        <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                            ...
                            <button class="btn btn-success border-0" id="addRows" type="button">+ Add More</button>
                        </div>
                    </div>
                    <div class="row">
